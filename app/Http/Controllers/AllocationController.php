...
class AllocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $empName = $empEmail->email;

        // $to = $empMail;
        // $subject = "Asset Allocated Alert";
        // $message = "Dear " . $empName . " You have been allocated a asset.";
        // $headers = "From: jhossain.cse@gmail.com" . "\r\n" . "CC: jhossain.cse@gmail.com";
        ...
        // $to2 = $adminMail;
        // $subject2 = "Asset Allocated Alert";
        // $message2 = "Dear " . $adminMail . " One Asset has been Allocated.";
        // $headers2 = "From: jhossain.cse@gmail.com" . "\r\n" . "CC: jhossain.cse@gmail.com";
